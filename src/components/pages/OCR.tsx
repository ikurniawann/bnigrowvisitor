      ...
      for (let i = 0; i < jsonData.length; i++) {
        ...
        try {
          ...
          const visitorData = {
            ...
            business_field: String(row['Bidang Usaha'] || row['Bidang'] || '').trim() || undefined,
            company: String(row['Perusahaan'] || row['Company'] || '').trim() || undefined,
            chapter: String(row['Chapter'] || '').trim() || undefined,
            referral_name: String(row['Diajak oleh'] || row['Referral'] || '').trim() || undefined,
