...
const KANBAN_COLS = [
  ...
  { id: 'hadir', label: 'Hadir', color: 'bg-emerald-500', light: 'bg-emerald-50', dark: 'text-emerald-800' },
...
const STATUSES = {
  ...
  hadir:        { label: 'Hadir',             badge: 'bg-emerald-100 text-emerald-800' },
  tidak_hadir:  { label: 'Tidak Hadir',       badge: 'bg-red-100 text-red-800' },
  interview:    { label: 'Interview',         badge: 'bg-purple-100 text-purple-800' },
  member:       { label: 'Jadi Member',       badge: 'bg-cyan-100 text-cyan-800' },
  tidak_lanjut: { label: 'Tidak Lanjut',      badge: 'bg-gray-100 text-gray-800' },
}
                    ...
                    colVisitors.map((visitor) => (
                      <div
                        ...
                        className={`
                          ...
                          ${col.id === 'hadir' ? 'border-emerald-500' : ''}
